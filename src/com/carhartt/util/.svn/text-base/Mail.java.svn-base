...
//			System.err.println("邮件失败！" + e);
	...
	/*调用sendOut方法完成发送*/
	public static boolean sendAndCc(String to, String subject, String content) {
		String smtp = "smtp.126.com";// smtp服务器
		String from = "carharttscut@126.com";// 邮件显示名称
//		String to = "420257352@qq.com";// 收件人的邮件地址，必须是真实地址
//		String copyto = "";// 抄送人邮件地址
//		String subject = "测试邮件";// 邮件标题
//		String content = "你好！";// 邮件内容
		String username = "carharttscut@126.com";// 发件人真实的账户名
		String password = "carhartt";// 发件人密码
